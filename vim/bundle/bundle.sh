...
git clone "git://github.com/tomtom/quickfixsigns_vim.git"
...
git clone "git://github.com/austintaylor/vim-indentobject.git"
...
git clone "git://github.com/noahfrederick/Hemisu.git"

# Precision colorscheme for the vim text editor
git clone "git://github.com/altercation/vim-colors-solarized.git"

# Base16 Color Scheme
git clone 'chriskempson/base16-vim'

# More colorschemes
git clone "git://github.com/daylerees/colour-schemes"
